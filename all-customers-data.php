...
<head>
    ...
    <title>Super Admin - View Customers Data | <?php echo $webdata['webname']; ?></title>
                        ...
                        <table id="datatable1" class="table table-striped dt-responsive nowrap">
                            ...
                            <tbody>
                                ...
                                if(mysqli_num_rows($alldata)>0){
                                    ...
                                    <td class="text-center">
                                    <a href="admin-edit-c.php?key=<?php echo base64_encode($data['id']); ?>" class="btn btn-sm btn-success">
                                                        <i class="fa fa-edit"></i>
                                                        </a>
                                    <!-- <a href="finger/index.php?key=<?php echo base64_encode($data['id']); ?>" class="btn btn-sm btn-success">
                                    <img src="assets/img/icon.png" height="20px" alt="H">
                                                        </a> -->
                                    <a href="finger/fingerNew.php?key=<?php echo base64_encode($data['id']); ?>" class="btn btn-sm btn-success">
                                    <img src="assets/img/icon.png" height="20px" alt="H">
                                                        </a>
                                    <a href="download-finger.php?key=<?php echo base64_encode($data['id']); ?>" class="btn btn-sm btn-success">
                                                        <i class="fa fa-eye"></i>
                                                        </a>
                                    <a href="all-customers-data.php?key=<?php echo base64_encode($data['id']); ?>" class="btn btn-sm btn-danger">
