...
if(isset($_POST['sub']) && $_POST['sub'] ==1){
   ...
   if ($file_type=="application/pdf" ) {
    if(move_uploaded_file($_FILES['file']['tmp_name'], $targetfolder))
    {
        ...
        $res = mysqli_query($conn,"UPDATE customers SET poi='$link', status='Pending-POA' WHERE id='$id'");
        if($res){
       $success = true;
       ?>
       <script>
...
<html lang="en">
   <head>
      ...
      <title>Upload Proof Of Identity  - <?php echo $webdata['webname'] ?></title>
   ...
   ?>
      ...
      <div class="row page-header">
         <div class="col-lg-6 align-self-center ">
            ...
            <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item">Upload POI</li>
      ...
      <section class="main-content">
         ...
         <div class="col-sm-12">
            <div class="card">
               <div class="card-header card-default">Upload POI 
                  <br>
                  <?php
                  if($success == true){
                     ?>
