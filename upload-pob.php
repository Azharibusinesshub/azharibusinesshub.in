...
if(isset($_POST['sub']) && $_POST['sub'] ==1){
   ...
   if ($file_type=="application/pdf" ) {
    if(move_uploaded_file($_FILES['file']['tmp_name'], $targetfolder))
    {
        ...
        $res = mysqli_query($conn,"UPDATE customers SET pob='$link', status='In-Progress' WHERE id='$id'");
        if($res){
       $success = true;
       ?>
       <script>
...
<html lang="en">
   <head>
      ...
      <title>Upload Proof Of Birth  - <?php echo $webdata['webname'] ?></title>
   ...
   ?>
      ...
      <div class="row page-header">
         <div class="col-lg-6 align-self-center ">
            <h2>Upload Proof of Birth</h2>
            <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="#">Home</a></li>
               <li class="breadcrumb-item">Upload POB</li>
      ...
      <section class="main-content">
         ...
         <div class="col-sm-12">
            <div class="card">
               <div class="card-header card-default">Upload POB 
                  <br>
                  <?php
                  if($success == true){
                     ?>
