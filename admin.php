...
<html lang="en">
   <head>
      ...
      <title>Super Admin - Dashboard | <?php echo $webdata['webname']; ?></title>
     ...
     ?>    <!-- ============================================================== -->
      ...
      <div class="row page-header">
         <div class="col-lg-6 align-self-center">
            ...
            <a href="add-user.php" class="btn btn-success box-shadow btn-icon btn-rounded"><i class="fa fa-plus"></i> Create New User</a>
         </div>
		       </div>
            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header card-default">
                     <h3>Welcome to Superadmin Panel - <?php echo $sdata['name'] ?>	</h3>
                  </div>
                  <div class="card-body">
				  <div class="row">
							<div class="col">
									...
									<div class="row row-table">
										<div class="col-xs-8 padding-15 text-center">
											<h4 class="mv-0"><?php echo $totalusers; ?></h4>
							...
							<div class="col">
									...
									<div class="row row-table">
										<div class="col-xs-8 padding-15 text-center">
											<h4 class="mv-0"><?php echo $totalapplications; ?></h4>
							...
							<div class="col">
									...
									<div class="row row-table">
										<div class="col-xs-8 padding-15 text-center">
											<h4 class="mv-0"><?php echo $totalcompleted; ?></h4>
							...
							<div class="col">
									...
									<div class="row row-table">
										<div class="col-xs-8 padding-15 text-center">
											<h4 class="mv-0"><?php echo $totalrejected; ?></h4>
