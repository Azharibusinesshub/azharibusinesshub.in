...
<html lang="en">
   <head>
      ...
      <title>Retailer - Dashboard | <?php echo $webdata['webname']; ?></title>
     ...
     ?>    <!-- ============================================================== -->
      ...
      <div class="row page-header">
         <div class="col-lg-6 align-self-center">
            ...
            <a href="add-customer.php" class="btn btn-success box-shadow btn-icon btn-rounded"><i class="fa fa-plus"></i> Create New Entry</a>
         </div>
		       </div>
            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header card-default">
                     <h3>Welcome to Retailer Panel - <?php echo $sdata['name'] ?>	</h3>
                  </div>
                  <div class="card-body">
				  <div class="row">
							<div class="col">
									...
									<div class="row row-table">
										<div class="col-xs-8 padding-15 text-center">
											...
											<div class="margin-b-0 ">Wallet Balance</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col">
									...
									<div class="row row-table">
										<div class="col-xs-8 padding-15 text-center">
											<h4 class="mv-0"><?php echo $howmanycsret; ?></h4>
											<div class="margin-b-0">Total Customers</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col">
									...
									<div class="row row-table">
										<div class="col-xs-8 padding-15 text-center">
											<h4 class="mv-0"><?php echo $howmanycompret; ?></h4>
											<div class="margin-b-0">Completed</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col">
									...
									<div class="row row-table">
										<div class="col-xs-8 padding-15 text-center">
											<h4 class="mv-0"><?php echo $howmanyrejpret; ?></h4>
											<div class="margin-b-0">Rejected</div>
										</div>
									</div>
								</div>
							</div>
