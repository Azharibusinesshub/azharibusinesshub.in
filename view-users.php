...
if(isset($_GET['reset']) && $_GET['reset']!=NULL){
    ...
    $password = "UCL".rand(0000000,9999999);
    $res = mysqli_query($conn,"UPDATE users SET password='$password' WHERE id='$id'");
    if($res){
        $resetsuccess = true;
...
<head>
    ...
    <title>Super Admin - View users Data | <?php echo $webdata['webname']; ?></title>
...
<body>
    ...
    <div class="row page-header">
        ...
        <div class="col-lg-6 align-self-center text-right">
            <a href="add-user.php" class="btn btn-success box-shadow btn-icon btn-rounded"><i
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="card-header card-default">
                        View users Data - <?php echo $sdata['name']; ?> <br> <?php if($success==true){
                            ?>
                        ...
                        if($resetsuccess==true){
                            ?>
                            <p style="color:green;font-weight:bold;font-size:16px;">User Password Reset Success New Password Is : <?php echo $password; ?></p>
                            <?php
                        }
                        ?> </div>
                    <div class="card-body">
                        <table id="datatable1" class="table table-striped dt-responsive nowrap">
                            ...
                            <tbody>
                                ...
                                if(mysqli_num_rows($adminusers)>0){
                                    $x =0;
                                    while($data = mysqli_fetch_assoc($adminusers)){
                                          $x ++;
                                          if($data['id'] == 1){
                                              continue;
                                          }
