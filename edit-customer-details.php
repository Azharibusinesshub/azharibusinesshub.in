							...
							<div class="form-group">
									<div class="row">
										<div class="col-md-4">
											...
											<input type="text" placeholder="Full Name" id="fullname" name="fullname" class="form-control" value="<?php echo $data['name']; ?>" required>
										</div>
										<div class="col-md-4">
										...
										<input type="text" name="birthdate" value="<?php echo $data['dob']; ?>" />
										</div>
									</div>
										</div>
										<div class="col-md-4">
											<label for="Aadhaar">Aadhaar No.</label>
																						<input type="text" class="form-control" placeholder="<?php echo $data['aadhaar_no']; ?>" disabled>
																					</div>
									</div>
							</div>
							<div class="form-group">
									<div class="row">
										<div class="col-md-4">
											...
											<input id="mobileno" name="mobile" type="text" class="form-control" value="<?php echo $data['mobile_no']; ?>" required>
										</div>
										<div class="col-md-4">
											<label for="Email">Email ID</label>
											<input type="email" name="email" value="<?php echo $data['email']; ?>" class="form-control" value="">
										</div>
										<div class="col-md-4">
											<label for="Purpose">Purpose</label>
											<input type="text" id="purpose" name="purpose" class="form-control" value="<?php echo $data['purpose']; ?>" required>
										</div>
									</div>
								</div>
															<div class="form-group">
									<div class="row">
										...
										<div class="col-md-2">
										  <div class="card">
											<div class="card-body">
																								<div class="watermark">
												<img src="<?php if($data['finger1']!=NULL){echo $data['finger1'];}else{echo "assets/img/sd.jpg";} ?>" id="im1" class="img-fluid rounded-end border p-1">
												</div>
												...
												<button type="button" class="btn btn-outline-info px-4 mt-1 capture btn-sm w-100" data-id="1">Click</button>
										...
										<div class="col-md-2">
										  <div class="card">
											<div class="card-body">
																							<div class="watermark">
												<img src="<?php if($data['finger2']!=NULL){echo $data['finger2'];}else{echo "assets/img/sd.jpg";} ?>" id="im2" class="img-fluid rounded-end border p-1">
												</div>
												...
												<button type="button" class="btn btn-outline-info px-4 mt-1 capture btn-sm w-100" data-id="2">Click</button>
										...
										<div class="col-md-2">
										  <div class="card">
											<div class="card-body">
																							<div class="watermark">
												<img src="<?php if($data['finger3']!=NULL){echo $data['finger3'];}else{echo "assets/img/sd.jpg";} ?>" id="im3" class="img-fluid rounded-end border p-1">
												</div>
												...
												<button type="button" class="btn btn-outline-info px-4 mt-1 capture btn-sm w-100" data-id="3">Click</button>
										...
										<div class="col-md-2">
										  <div class="card">
											<div class="card-body">
																								<div class="watermark">
												<img src="<?php if($data['finger4']!=NULL){echo $data['finger4'];}else{echo "assets/img/sd.jpg";} ?>" id="im4" class="img-fluid rounded-end border p-1">
												</div>
												...
												<button type="button" class="btn btn-outline-info px-4 mt-1 capture btn-sm w-100" data-id="4">Click</button>
										...
										<div class="col-md-2">
										  <div class="card">
											<div class="card-body">
																								<div class="watermark">
												<img src="<?php if($data['finger5']!=NULL){echo $data['finger5'];}else{echo "assets/img/sd.jpg";} ?>" id="im5" class="img-fluid rounded-end border p-1">
												</div>
												...
												<button type="button" class="btn btn-outline-info px-4 mt-1 capture btn-sm w-100" data-id="5">Click</button>
