		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-header">
					...
					<h1 style="color : white"><?php echo $b['aadhaar_no'] ?> Aadhar Number</h1>  
				</div>
			</div>
		</div>
		<div class="row">
		    <div class="col-6">
		        <a href="../all-customers-data.php" class="btn btn-primary">Back To Dashbaord</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<!-- Wrapper for slides -->
						<div class="carousel-inner" role="listbox">
							<div class="item active panzoom">
								<img src="<?php echo $b['finger1'] ?>" class="img-responsive" alt="Dicom" style="padding : 26%; filter: grayscale(-48%);filter: invert(1);--value: 100%;transform: scaleX(-1);" id="fingerprint">
							</div>
							<div class="item panzoom">
								<img src="<?php echo $b['finger2'] ?>" class="img-responsive" alt="Dicom" style="padding : 26%; filter: grayscale(-48%);filter: invert(1);--value: 100%;transform: scaleX(-1);" id="fingerprint">
							</div>
							<div class="item panzoom">
								<img src="<?php echo $b['finger3'] ?>" class="img-responsive" alt="Dicom" style="padding : 26%; filter: grayscale(-48%);filter: invert(1);--value: 100%;transform: scaleX(-1);" id="fingerprint">
							</div>
							<div class="item panzoom">
								<img src="<?php echo $b['finger4'] ?>" class="img-responsive" alt="Dicom" style="padding : 26%; filter: grayscale(-48%);filter: invert(1);--value: 100%;transform: scaleX(-1);" id="fingerprint">
							</div>
							<div class="item panzoom">
								<img src="<?php echo $b['finger5'] ?>" class="img-responsive" alt="Dicom" style="padding : 26%; filter: grayscale(-48%);filter: invert(1);--value: 100%;transform: scaleX(-1);" id="fingerprint">
							</div>
						</div>
